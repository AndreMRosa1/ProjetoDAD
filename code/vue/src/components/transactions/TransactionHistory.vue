    ...
    <div v-if="!transactionHistoryStore.isLoading && !transactionHistoryStore.error">
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="flex justify-around bg-green-600 text-white font-semibold rounded-md p-2">
          <span v-if="authStore.user.type == 'A'" class="flex-1 text-center">User</span>
        ...
        <div v-for="transaction in transactionHistoryStore.transactions" :key="transaction.id"
          class="flex justify-around border-b last:border-b-0 hover:bg-green-100 p-2">
          <span v-if="authStore.user.type == 'A'" class="flex-1 text-center">
      ...
      <div class="flex justify-center items-center mt-6 gap-4">
        ...
        <div class="flex items-center gap-2">
          <input type="number" v-model="transactionHistoryStore.inputPage" min="1"
            :max="transactionHistoryStore.totalPages" class="text-center px-1 py-2 border rounded-md w-16"
