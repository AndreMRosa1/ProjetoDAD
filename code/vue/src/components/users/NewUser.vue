    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <div>
            ...
            <select v-model="userType" id="user_type" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
